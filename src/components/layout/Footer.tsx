...
const DEFAULT_FOOTER = {
  ...
  contactAddress: '456 Innovation Drive, Tech Valley',
  newsletterTitle: 'Stay Updated',
  newsletterPlaceholder: 'Enter your email',
  newsletterDisclaimer:
    'Get the latest robotics insights and updates. No spam, unsubscribe anytime.',
  section1Title: 'Solutions',
  section2Title: 'Company',
  section3Title: 'Resources',
  section4Title: 'Legal',
  copyrightText: '© 2024 RoboTech. All rights reserved.',
  madeWithText: 'by our robotics team',
  ...
  // Product Links
  linkFeatures: 'AI Robotics',
  linkFeaturesHref: '/ai-robotics',
  linkPricing: 'Industrial Bots',
  linkPricingHref: '/industrial',
  linkTemplates: 'Automation',
  linkTemplatesHref: '/automation',
